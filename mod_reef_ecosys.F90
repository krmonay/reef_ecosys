...
# endif
      ...
      real(8) :: w_POM
      real(8) :: Fw_POC(0:N)
      real(8) :: Fw_PHY(0:N), Fw_ZOO(0:N)
      real(8) :: Fdep_POC
      real(8) :: Fdep_PHY, Fdep_ZOO
# if defined NUTRIENTS
      real(8) :: Fw_PON(0:N)
      real(8) :: Fw_POP(0:N)
      real(8) :: Fdep_PON
...
!          input parameters
     ...
     &            ,PHY(k)         &   ! phytoplankton (umol C L-1)
...
!----- Mass balance equation -----------------------------------------------------------
        ...
        dPHY_dt(k) = dPHY_dt(k) + dPHY + (Fw_PHY(k-1)-Fw_PHY(k))/dz(k)
...
!        cff=0.01d0 /dz(1) * p_coral*4.0d0  !!!*~4.0d0 convert projected area to coral surface area (Naumann et al. 2009)
        cff=0.01d0 /dz(1) * p_coral*8.0d0  !!!*~8.0d0 convert projected area to coral surface area (Jokiel & Morrissey 1986; Nakamura and Nakamori 2009)
