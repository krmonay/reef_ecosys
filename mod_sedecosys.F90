...
!!! ----- Isotope calculation (ÎŠD‰»‚Ì‰e‹¿‚Ü‚¾“ü‚ê‚Ä‚È‚¢!!!!)----------
# if defined CARBON_ISOTOPE
...
!---- Aerobic respiration --------------------------
      real(8), parameter :: Rp_max =  1.0d-3     !(nmol cm-3 s-1)  !!!‚Ä‚«‚Æ‚¤
      real(8), parameter :: Krp_POC = 1.0d0     !(umol L-1)  !!!‚Ä‚«‚Æ‚¤
      real(8), parameter :: Krp_DO =  10.0d0     !(umol L-1)  !!!‚Ä‚«‚Æ‚¤
      real(8), parameter :: Rd_max =  5.0d-3     !(nmol cm-3 s-1)  !!!‚Ä‚«‚Æ‚¤
...
!      NH4+ + (3/2)O2 -> NO2- + 2H2O + 2H+
      real(8), parameter :: Nit1_max =  10.0d0 !!!10.0d0  !(nmol cm-3 s-1)  !!!‚Ä‚«‚Æ‚¤
      real(8), parameter :: Kn1_NH4 =  250.0d0   !(umol L-1)  !!!‚Ä‚«‚Æ‚¤
      real(8), parameter :: Kn1_DO =  5.0d0   !(umol L-1)  !!!‚Ä‚«‚Æ‚¤
!      NO2- + (1/2)O2 -> NO3-
      real(8), parameter :: Nit2_max =  10.0d0 !!!10.0d0  !(nmol cm-3 s-1)  !!!‚Ä‚«‚Æ‚¤
      real(8), parameter :: Kn2_NO2 =  250.0d0   !(umol L-1)  !!!‚Ä‚«‚Æ‚¤
      real(8), parameter :: Kn2_DO =  5.0d0   !(umol L-1)  !!!‚Ä‚«‚Æ‚¤
!---- Denitrification --------------------------
