...
!------- Phytoplankton parameters ------------------------
      real(8), parameter :: k_Pphy1 =  1.0d0/86400.0d0     ! (s-1)          PHY maximum photosynthesis rate at 0 oC (1.0d0 d-1; Kawamiya et al., 1995)
      real(8), parameter :: b_Pphy1 =  0.063d0             ! (degC-1)       Temperature coefficient for PHY photosynthesis (Kawamiya et al., 1995)
      ...
      real(8), parameter :: k_Mphy1 =  0.00281d0/86400.0d0 ! (umol-1 s-1)   PHY mortality rate at 0 oC (0.00281d0 umol-1 d-1; Kishi et al., 2001)
      ...
      real(8), parameter :: k_Pphy2 =  1.0d0/86400.0d0     ! (s-1)          PHY maximum photosynthesis rate at 0 oC (1.0d0 d-1; Kawamiya et al., 1995)
      real(8), parameter :: b_Pphy2 =  0.063d0             ! (degC-1)       Temperature coefficient for PHY photosynthesis (Kawamiya et al., 1995)
      ...
      real(8), parameter :: k_Mphy2 =  0.00281d0/86400.0d0 ! (umol-1 s-1)   PHY mortality rate at 0 oC (0.00281d0 umol-1 d-1; Kishi et al., 2001)
...
#if defined NUTRIENTS         
      real(8), parameter :: Kphy1_NH4 = 2.0d0   ! (s-1)0.2         
      real(8), parameter :: Kphy1_NO3 = 0.1d0   ! (s-1)0.1         
      real(8), parameter :: Kphy1_PO4 = 0.01d0   ! (s-1)0.01         
      real(8), parameter :: Kphy2_NH4 = 2.0d0   ! (s-1)     1.0d0   (Kawamiya et al., 2000) 
      real(8), parameter :: Kphy2_NO3 = 0.1d0   ! (s-1)     0.03d0  (Kawamiya et al., 2000)  
      real(8), parameter :: Kphy2_PO4 = 0.01d0   ! (s-1)         
      real(8), parameter :: psi =  0.01d0    !(s-1)          
#endif
!------- Zooplankton parameters ------------------------
      real(8), parameter :: k_Gphy12zoo = 0.2d0/86400.0d0 ! (s-1)          Maximum grazing rate of PHY by ZOO (0.3d0 d-1; Kawamiya et al., 1995)
      real(8), parameter :: b_Gphy12zoo = 0.0315d0         ! (degC-1)       Temperature coefficient for ZOO grazing (0.063d0degC-1;Kawamiya et al., 1995)
      real(8), parameter :: e_Gphy12zoo = 0.7d0           ! (no dim.)      Assimilation efficiency of ZOO (Kawamiya et al., 1995)
      real(8), parameter :: k_Gphy22zoo = 0.1d0/86400.0d0 ! (s-1)          Maximum grazing rate of PHY by ZOO (0.3d0 d-1; Kawamiya et al., 1995)
      real(8), parameter :: b_Gphy22zoo = 0.0315d0         ! (degC-1)       Temperature coefficient for ZOO grazing (Kawamiya et al., 1995)
      real(8), parameter :: e_Gphy22zoo = 0.7d0           ! (no dim.)      Assimilation efficiency of ZOO (Kawamiya et al., 1995)
      ...
      real(8), parameter :: k_Mzoo = 3.0d-1/86400.0d0  !! (umol-1 s-1)   ZOO mortality rate at 0 oC 3.0d0/86400.0d0(0.0088d0 umol-1 d-1; Kawamiya et al., 1995)
...
!----- Grazing rate of PHY by ZOO (umolC L-1 s-1) -----------------
      Gphy12zoo = k_Gphy12zoo * exp(b_Gphy12zoo*Tmp) * PHY1 * ZOO
      Gphy22zoo = k_Gphy22zoo * exp(b_Gphy22zoo*Tmp) * PHY2 * ZOO
...
#if defined NUTRIENTS         
      dNO3_dt = -Vphy1_NO3/(Vphy1_NO3 + Vphy1_NH4)*Aphy1/rCNphy1 - Vphy2_NO3/(Vphy2_NO3 + Vphy2_NH4)*Aphy2/rCNphy2
      dNO2_dt = 0.0d0
