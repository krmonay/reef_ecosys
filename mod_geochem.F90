...
! ------ Molecular diffusion coefficients in seawater @ 25 degC, 35 psu -----
    ...
    real(8), parameter :: dif_HCO3 = 1.2d-9   ! Bicarbonate ion HCO3- (m2 s-1)
    real(8), parameter :: dif_CO3  = 0.96d-9  ! Carbonate ion CO32-   (m2 s-1)
    ...
    real(8), parameter :: dif_H    = 9.3d-9   ! Proton H+             (m2 s-1)
    real(8), parameter :: dif_OH   = 5.3d-9   ! OH-                   (m2 s-1)
